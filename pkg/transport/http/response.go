...
// Response builds a JSON API envelope that always serializes with HTTP 200.
...
// Ok writes the JSON envelope with HTTP 200.
func (r *Response) Ok() error {
	...
	return r.ctx.Status(fiber.StatusOK).JSON(out)
}
